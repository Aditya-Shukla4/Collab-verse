// FINAL CODE FOR: src/pages/SignupPage.jsx
...
export default function SignupPage() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      // Success ke baad user ko login page pe bhej denge
      const { token } = response.data;
      localStorage.setItem("token", token); // Save the token to auto-login

      router.push("/create-profile"); // Redirect to create profile page
    } catch (error) {
