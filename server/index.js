...
// The client URL from environment variables, with a fallback for local dev
const clientURL = process.env.CLIENT_URL || "http://localhost:3000";

// --- DEBUG LOG ---
// This will print the URL to your Render logs so you can confirm it's correct.
...
const io = new Server(httpServer, {
  cors: {
    origin: clientURL, // Use the same variable for Socket.IO
    methods: ["GET", "POST"],
  },
});
